 ...
 * Ms. Krasteva
 * 4/8/2021
 * This program can run the SpringLayoutRyken independently.
 */

import java.awt.event.*;
import javax.swing.*;

public class SpringLayoutEx extends JFrame implements ActionListener {
	//creates a FlowLayoutPanel object
	SpringLayoutRyken panel = new SpringLayoutRyken();
